...
class DataValidationConfig:
    def __init__(self,training_pipeline_config:training_pipeline_config):
        ...
        self.valid_train_file_path: str = os.path.join(self.valid_data_dir, training_pipeline.TRAINING_DATA)
        self.valid_test_file_path: str = os.path.join(self.valid_data_dir, training_pipeline.TEST_DATA)
        self.invalid_train_file_path: str = os.path.join(self.invalid_data_dir, training_pipeline.TRAINING_DATA)
        self.invalid_test_file_path: str = os.path.join(self.invalid_data_dir, training_pipeline.TEST_DATA)
